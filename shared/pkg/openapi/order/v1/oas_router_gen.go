				...
				case '/': // Prefix: "/"
					...
					case 'p': // Prefix: "pay"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "POST":
								s.handleOrderPaymentRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "POST")
		...
		case '/': // Prefix: "/api/v1/orders"
			...
			if len(elem) == 0 {
				...
				case "POST":
					...
					r.summary = "Create a new order with selected details"
			...
			case '/': // Prefix: "/"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "returns order using uuid"
				...
				case '/': // Prefix: "/"
					...
					case 'p': // Prefix: "pay"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "POST":
								r.name = OrderPaymentOperation
								r.summary = "Current order payment"
								r.operationID = "OrderPayment"
