...
// list of methods
type PaymentMethod_Method int32

const (
	PaymentMethod_METHOD_UNSPECIFIED PaymentMethod_Method = 0
	PaymentMethod_METHOD_CARD        PaymentMethod_Method = 1
	PaymentMethod_METHOD_SBP         PaymentMethod_Method = 2
	PaymentMethod_METHOD_TRANSFER    PaymentMethod_Method = 3
)

// Enum value maps for PaymentMethod_Method.
var (
	PaymentMethod_Method_name = map[int32]string{
		0: "METHOD_UNSPECIFIED",
		1: "METHOD_CARD",
		2: "METHOD_SBP",
		3: "METHOD_TRANSFER",
	}
	PaymentMethod_Method_value = map[string]int32{
...
func (x PaymentMethod_Method) Enum() *PaymentMethod_Method {
	p := new(PaymentMethod_Method)
	*p = x
	return p
}

func (x PaymentMethod_Method) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PaymentMethod_Method) Descriptor() protoreflect.EnumDescriptor {
	return file_payment_v1_payment_proto_enumTypes[0].Descriptor()
}

func (PaymentMethod_Method) Type() protoreflect.EnumType {
	return &file_payment_v1_payment_proto_enumTypes[0]
}

func (x PaymentMethod_Method) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PaymentMethod_Method.Descriptor instead.
func (PaymentMethod_Method) EnumDescriptor() ([]byte, []int) {
...
var file_payment_v1_payment_proto_goTypes = []any{
	(PaymentMethod_Method)(0), // 0: payment.v1.PaymentMethod.Method
...
var file_payment_v1_payment_proto_depIdxs = []int32{
	...
	3, // 2: payment.v1.PaymentService.PayOrder:output_type -> payment.v1.PayOrderResponse
