...
func (x *Dimensions) GetHight() float64 {
	if x != nil {
		return x.Hight
	}
	return 0
...
// Partsfilter for search through filter
type Partsfilter struct {
	...
	ManufacturersCountries []string               `protobuf:"bytes,4,rep,name=manufacturers_countries,json=manufacturersCountries,proto3" json:"manufacturers_countries,omitempty"`
...
func (x *Partsfilter) GetManufacturersCountries() []string {
	if x != nil {
		return x.ManufacturersCountries
	}
	return nil
}
...
// Response for the GetPart
type GetPartResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Info          *Part                  `protobuf:"bytes,1,opt,name=info,proto3" json:"info,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetPartResponse) GetInfo() *Part {
	if x != nil {
		return x.Info
	}
	return nil
...
// Request for the show of the part
...
// Response for the show of the part
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"\x1cinventory/v1/inventory.proto\x12\finventory.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17validate/validate.proto\"h\n" +
	"\n" +
	"Dimensions\x12\x16\n" +
	"\x06length\x18\x01 \x01(\x01R\x06length\x12\x14\n" +
	"\x05width\x18\x02 \x01(\x01R\x05width\x12\x14\n" +
	"\x05hight\x18\x03 \x01(\x01R\x05hight\x12\x16\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x13.inventory.v1.ValueR\x05value:\x028\x01\"\xbe\x01\n" +
	...
	"\rCATEGORY_WING\x10\x042\xc3\x01\n" +
	"\x10InventoryService\x12a\n" +
	"\aGetPart\x12\x1c.inventory.v1.GetPartRequest\x1a\x1d.inventory.v1.GetPartResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/api/v1/orders\x12L\n" +
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBbZ`github.com/NikitaSpiridonov/App-for-Supply-Department/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	4,  // 7: inventory.v1.GetPartResponse.info:type_name -> inventory.v1.Part
